...
var arrayMin = Highcharts.arrayMin,
	...
	mathMax = math.max,
	noop = function () {};/**
 * The Pane object allows options that are support to a set of X and Y axes.
 * 
...
seriesTypes.arearange = Highcharts.extendClass(seriesTypes.area, {
	...
	drawDataLabels: function () {
		...
		if (dataLabelOptions.enabled || this._hasPointLabels) {
			...
			// Step 2: reorganize and handler data labels for the lower values
			i = length;
			while (i--) {
				point = data[i];
...
seriesTypes.bubble = extendClass(seriesTypes.scatter, {
	...
	/**
	 * Extend the base translate method to handler bubble size
	 */
	translate: function () {
