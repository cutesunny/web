...
(function (Highcharts) {
	...
	extend(Chart.prototype, {
		 ...
		 * in Highcharts, perhaps it should be elevated to a support utility function.
		 */
	...
	seriesTypes.map = Highcharts.extendClass(seriesTypes.scatter, {
		...
		/** 
		 * Use the drawPoints method of column, that is able to handler simple shapeArgs.
